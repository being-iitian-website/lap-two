...
const routine_controller_1 = require("../controllers/performance/routine.controller");
...
router.get("/routine/sleep", routine_controller_1.getSleepRoutine);
router.get("/routine/health", routine_controller_1.getHealthRoutine);
// Hours routes
